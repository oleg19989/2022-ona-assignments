...
```
    ...
    ## IGRAPH 8f8bbab UN-- 10 17 -- 
    ## + attr: name (v/c)
    ## + edges from 8f8bbab (vertex names):
...
![](Exercise-2_files/figure-gfm/plot%201-1.png)<!-- -->
...
![](Exercise-2_files/figure-gfm/plot%202-1.png)<!-- -->
...
![](Exercise-2_files/figure-gfm/plot%203-1.png)<!-- -->
...
![](Exercise-2_files/figure-gfm/eigenvector%20centrality-1.png)<!-- -->
...
![](Exercise-2_files/figure-gfm/bonacich%20centrality-1.png)<!-- -->
...
![](Exercise-2_files/figure-gfm/Page%20Rank-1.png)<!-- -->
